...
- **Handle both webhook systems.** They are separate: [online webhooks](/online-payments/after-payments/webhook-events) require an acknowledgment body, [in-store webhooks](/in-store/webhooks) do not and may be encrypted. Build two handlers, not one.
