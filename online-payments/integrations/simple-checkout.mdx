...
| description | `string` | Decription of the transaction | Yes |
 ...
 <body>
    ...
    <script type ="text/javascript">
      function paywithSeerbit() {
        ...
        "tranref": new Date().getTime(), // payment reference
        "currency": "NGN",
        "country": "NG",
        "amount": "150.00",
...
```json
"decription": "test payment description",
...
Click your **Pay Now** button and use our [test cards](/testing/overview) to simulate transactions. No real funds will be debited.<br /> To learn how to verify payments, visit our [Payment Verification Guide](/online-payments/after-payments/verify-payment).
