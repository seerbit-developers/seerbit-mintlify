...
- Set up [webhooks](webhooks) for secure, server-side payment confirmation. Do not rely solely on browser redirects.
...
- For testing, use SeerBit [test cards](testing).

## Troubleshooting

If the payment modal does not appear, check your browser console for errors (commonly a missing publicKey). For full parameter details, visit the [Standard Checkout API Reference](api-reference/standard-checkout/generate-hash).
